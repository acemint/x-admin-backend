...
public class EmployeeControllerDocs {
  ...
  public static final String LOGIN_DESCRIPTION = "Authenticates a user in the system by using session-id. See here for reference:<br>"
      + "https://docs.spring.io/spring-security/reference/servlet/authentication/session-management.html"
      + "https://docs.spring.io/spring-security/reference/servlet/exploits/csrf.html<br>"
      + "https://security.stackexchange.com/questions/166724/should-i-use-csrf-protection-on-rest-api-endpoints/166798#166798.<br>"
